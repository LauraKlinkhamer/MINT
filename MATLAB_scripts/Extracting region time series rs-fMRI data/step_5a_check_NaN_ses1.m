...
subList = 2%[2:13, 17, 18, 22, 24, 25, 27:48, 50:52]; 
sesNum = 1;
...
load (fullfile(cortical_atlas_folder, [['sub-' num2str(subList(sub_i),'%02.f')] ['_ses-' sesName] '_task-rest_run-1_setting-preproc0mmICA_cortical_atlas_timeseries.mat']));
    ...
    if sum(isnan(timeseries_complete_atlas(:))) > 0 
        disp([['sub-' num2str(subList(sub_i),'%02.f')] ['_ses-' sesName] 'NaN present in ses-1 0mm ICA complete atlas'])
    ...
    if sum(isnan(timeseries_brainnetome_cortical_atlas(:))) > 0
        disp([['sub-' num2str(subList(sub_i),'%02.f')] ['_ses-' sesName] ' NaN present in ses-1 0mm ICA cortical atlas'])
...
load (fullfile(cortical_atlas_folder, [['sub-' num2str(subList(sub_i),'%02.f')] ['_ses-' sesName] '_task-rest_run-1_setting-preproc0mmACompCor_cortical_atlas_timeseries.mat']));
    ...
    if sum(isnan(timeseries_complete_atlas(:))) > 0
       disp([['sub-' num2str(subList(sub_i),'%02.f')] ['_ses-' sesName] ' NaN present in ses-1 0mm ACompCor complete atlas'])
    ...
    if sum(isnan(timeseries_brainnetome_cortical_atlas(:))) > 0
        disp([['sub-' num2str(subList(sub_i),'%02.f')] ['_ses-' sesName] ' NaN present in ses-1 0mm ACompCor cortical atlas'])
        [rows, columns] = find(isnan(timeseries_brainnetome_cortical_atlas));
        disp(unique(rows))
...
load (fullfile(cortical_atlas_folder, [['sub-' num2str(subList(sub_i),'%02.f')] ['_ses-' sesName] '_task-rest_run-1_setting-preproc3mmICA_cortical_atlas_timeseries.mat']));
    ...
    if sum(isnan(timeseries_complete_atlas(:))) > 0
        disp([['sub-' num2str(subList(sub_i),'%02.f')] ['_ses-' sesName] 'NaN present in ses-1 3mm ICA complete atlas'])
        [rows, columns] = find(isnan(timeseries_complete_atlas));
        disp(unique(rows))
    ...
    if sum(isnan(timeseries_brainnetome_cortical_atlas(:))) > 0
        disp([['sub-' num2str(subList(sub_i),'%02.f')] ['_ses-' sesName] ' NaN present in ses-1 3mm ICA cortical atlas'])
        [rows, columns] = find(isnan(timeseries_brainnetome_cortical_atlas));
        disp(unique(rows))
...
load (fullfile(cortical_atlas_folder, [['sub-' num2str(subList(sub_i),'%02.f')] ['_ses-' sesName] '_task-rest_run-1_setting-preproc3mmACompCor_cortical_atlas_timeseries.mat']));
    ...
    if sum(isnan(timeseries_complete_atlas(:))) > 0
       disp([['sub-' num2str(subList(sub_i),'%02.f')] ['_ses-' sesName] ' NaN present in ses-1 3mm ACompCor complete atlas'])
        [rows, columns] = find(isnan(timeseries_complete_atlas));
        disp(unique(rows))
    ...
    if sum(isnan(timeseries_brainnetome_cortical_atlas(:))) > 0
        disp([['sub-' num2str(subList(sub_i),'%02.f')] ['_ses-' sesName] ' NaN present in ses-1 3mm ACompCor cortical atlas'])
        [rows, columns] = find(isnan(timeseries_brainnetome_cortical_atlas));
        disp(unique(rows))
...
load (fullfile(cortical_atlas_folder, [['sub-' num2str(subList(sub_i),'%02.f')] ['_ses-' sesName] '_task-rest_run-1_setting-preproc6mmICA_cortical_atlas_timeseries.mat']));
    ...
    if sum(isnan(timeseries_complete_atlas(:))) > 0
        disp([['sub-' num2str(subList(sub_i),'%02.f')] ['_ses-' sesName] 'NaN present in ses-1 6mm ICA complete atlas'])
        [rows, columns] = find(isnan(timeseries_complete_atlas));
        disp(unique(rows))
    ...
    if sum(isnan(timeseries_brainnetome_cortical_atlas(:))) > 0
        disp([['sub-' num2str(subList(sub_i),'%02.f')] ['_ses-' sesName] ' NaN present in ses-1 6mm ICA cortical atlas'])
        [rows, columns] = find(isnan(timeseries_brainnetome_cortical_atlas));
        disp(unique(rows))
...
load (fullfile(cortical_atlas_folder, [['sub-' num2str(subList(sub_i),'%02.f')] ['_ses-' sesName] '_task-rest_run-1_setting-preproc6mmACompCor_cortical_atlas_timeseries.mat']));
    ...
    if sum(isnan(timeseries_complete_atlas(:))) > 0
       disp([['sub-' num2str(subList(sub_i),'%02.f')] ['_ses-' sesName] ' NaN present in ses-1 6mm ACompCor complete atlas'])
       [rows, columns] = find(isnan(timeseries_complete_atlas));
        disp(unique(rows))
    ...
    if sum(isnan(timeseries_brainnetome_cortical_atlas(:))) > 0
        disp([['sub-' num2str(subList(sub_i),'%02.f')] ['_ses-' sesName] ' NaN present in ses-1 6mm ACompCor cortical atlas'])
        [rows, columns] = find(isnan(timeseries_brainnetome_cortical_atlas));
        disp(unique(rows))
